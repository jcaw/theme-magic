;; TODO: Include copyright information, copy from original spacemacs-common.el
...
(defun wal-create-theme (wal-black   wal-red   wal-green   wal-yellow   wal-blue   wal-magenta   wal-cyan   wal-white
  ...
  (let*
      (
       ...
       (actual-red-bg     (wal-blend background actual-red 0.1))
       (actual-red-bg-s   (wal-blend background actual-red 0.2))
       (actual-green      (wal-override-hsl true-green nil average-saturation average-lightness))
       (actual-green-bg   (wal-blend background actual-green 0.1))
       (actual-green-bg-s (wal-blend background actual-green 0.2))
       (actual-blue      (wal-override-hsl true-blue nil average-saturation average-lightness))
       (actual-blue-bg   (wal-blend background actual-blue 0.1))
       (actual-blue-bg-s (wal-blend background actual-blue 0.2))
       (actual-yellow      (wal-override-hsl true-yellow nil average-saturation average-lightness))
       (actual-yellow-bg   (wal-blend background actual-yellow 0.1))
       (actual-yellow-bg-s (wal-blend background actual-yellow 0.2))
       (actual-cyan      (wal-override-hsl true-cyan nil average-saturation average-lightness))
       (actual-cyan-bg   (wal-blend background actual-cyan 0.1))
       (actual-cyan-bg-s (wal-blend background actual-cyan 0.2))
